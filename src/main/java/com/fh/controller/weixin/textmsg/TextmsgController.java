    ...
    extends BaseController
{
    ...
    private static final String MENU_URL = "textmsg/list.do";
    ...
    {
        logBefore(logger, "delete Textmsg");
    ...
    public ModelAndView edit()
        throws Exception
    {
        logBefore(logger, "update Textmsg");
    ...
    {
        logBefore(logger, "go to Textmsg page");
        ModelAndView mv = getModelAndView();
        PageData pd = getPageData();
        try {
    ...
    {
        logBefore(logger, "bulk delete Textmsg");
        if (!Jurisdiction.buttonJurisdiction(MENU_URL, "del")) {
            return null;
        }
        PageData pd = getPageData();
    ...
    {
        logBefore(logger, "exprot Textmsg to excel");
