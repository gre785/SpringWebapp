    ...
    extends BaseController
{
        ...
        throws Exception
    {
        ...
        if (null == _appuserService.findByUId(pd) && Jurisdiction.buttonJurisdiction(menuUrl, "add")) {
            _appuserService.saveU(pd);
        }
    ...
    public Object hasU()
    {
        ...
        PageData pd = getPageData();
        try {
            if (_appuserService.findByUId(pd) != null) {
                errInfo = "error";
            }
        } catch (Exception e) {
    ...
    public Object hasE()
    {
        ...
        PageData pd = getPageData();
        try {
            if (_appuserService.findByUE(pd) != null) {
                errInfo = "error";
            }
        } catch (Exception e) {
            logger.error(e.toString(), e);
    ...
    public Object hasN()
    {
        ...
        PageData pd = getPageData();
        try {
            if (_appuserService.findByUN(pd) != null) {
                errInfo = "error";
            }
        } catch (Exception e) {
            logger.error(e.toString(), e);
    ...
    public ModelAndView goEditU()
    {
        ...
        PageData pd = getPageData();
        try {
            List<Role> roleList = _roleService.listAllappERRoles();
            pd = _appuserService.findByUiId(pd);
    ...
    public ModelAndView goAddU()
    {
        ...
        try {
            List<Role> roleList;
            roleList = _roleService.listAllappERRoles();
            mv.setViewName("system/appuser/appuser_edit");
    ...
    public ModelAndView listUsers(Page page)
    {
        ...
        try {
            ...
            page.setPd(pd);
            List<PageData> userList = _appuserService.listPdPageUser(page);
            List<Role> roleList = _roleService.listAllappERRoles();
    ...
    public Object deleteAllU()
    {
        ...
        try {
            ...
            if (null != USER_IDS && !"".equals(USER_IDS)) {
                ...
                if (Jurisdiction.buttonJurisdiction(menuUrl, "del")) {
                    _appuserService.deleteAllU(ArrayUSER_IDS);
                }
                pd.put("msg", "ok");
            } else {
                pd.put("msg", "no");
    ...
    public ModelAndView exportExcel()
    {
        ...
        try {
            if (Jurisdiction.buttonJurisdiction(menuUrl, "cha")) {
                ...
                List<PageData> userList = _appuserService.listAllUser(pd);
